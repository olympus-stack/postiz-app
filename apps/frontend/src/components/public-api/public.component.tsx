...
const PublicApiContent = () => {
  ...
  return (
    <div className="flex flex-col gap-[20px]">
      <div className="flex flex-col">
        ...
        <div className="text-customColor18 mt-[4px]">
          {t(
            ...
            'Use Eros API to integrate with your tools.'
          )}
          <br />
          <a
          ...
          >
            <br />
            {t('check_n8n', 'Check out our N8N custom node for Eros.')}
          </a>
        </div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <div className="text-customColor18 mt-[4px]">
          {t(
            ...
            'Connect Eros MCP server to your client (Http streaming) to schedule your posts faster.'
          )}
        </div>
        <div className="my-[16px] mt-[16px] bg-sixth border-fifth items-center border rounded-[4px] p-[24px] flex gap-[24px]">
          <div className="flex items-center">
      ...
      <div className="flex flex-col">
        <h3 className="text-[20px]">Building your Eros payload</h3>
        <div className="text-customColor18 mt-[4px] whitespace-pre-line">
          ...
          We have created an easy way to build your Eros payload to schedule
          posts. {'\n'}
          You can use the Eros wizard, and schedule a post with our UI, after
