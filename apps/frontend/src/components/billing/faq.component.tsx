  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Eros?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information Eros will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Eros' : 'Eros'}?`
      ),
      description: t(
